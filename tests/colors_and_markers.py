...
'stereoglue (MAGSAC)': 'StereoGlue',
'stereoglue (MSAC)': 'StereoGlue',
'stereoglue (RANSAC)': 'StereoGlue',
...
colormap_dict = {
    ...
    'stereoglue (MAGSAC)': mpl.cm.get_cmap('tab10')(3),
    'stereoglue (MSAC)': mpl.cm.get_cmap('tab10')(3),
    'stereoglue (RANSAC)': mpl.cm.get_cmap('tab10')(3)
}
